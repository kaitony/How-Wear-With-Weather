/**
 * dialog.tsx
 * Radix UI Dialog를 기반으로 한 모달 다이얼로그 컴포넌트 모음
 *
 * Dialog, DialogTrigger, DialogContent, DialogHeader, DialogFooter, DialogTitle, DialogDescription 등
 * 다이얼로그 구성에 필요한 여러 컴포넌트를 제공한다.
 * 닫기 버튼, 오버레이 애니메이션 등을 포함한다.
 */
